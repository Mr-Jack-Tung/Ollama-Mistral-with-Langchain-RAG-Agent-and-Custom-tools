...
## Lý do:
- Một trong những trở ngại cơ bản của người bắt đầu làm AI đó là phải trả phí sử dụng ChatGPT cho OpenAI hoặc có model đủ tốt để chạy thử nghiệm. Giờ đây đã có thể chạy được các Model mới nhất trên Laptop local với tốc độ rất nhanh với Ollama nhé ^^
